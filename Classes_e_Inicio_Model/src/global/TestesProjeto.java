...
public class TestesProjeto {
	...
	public static void main(String[] args) {
		...
		Projeto projeto1 = new Projeto("Necto");          	  // criando projeto1, lembrando que o projeto tem que ter a flexibilidade de adicionar data inicio e data fim depois
		Tarefa tarefa2 = new Tarefa ("Planejar");			  // criando a tarefa 1 e 2, lembrando que as tarefas devem ter a opção de adicionar data inicio e data fim depois
		Tarefa tarefa1 = new Tarefa ("Teste");				
		
		tarefa1.add_dataInicioTarefa("01/05/2020");
		tarefa1.add_dataFimTarefa("31/05/2020");
		...
		tarefa1.qtde_diasTarefa();     					//      = 2 dias * 3 pessoas * 8 horas de trabalho por dia  = 48 horas             
		tarefa1.qtde_horasTarefa();  
		tarefa2.qtde_horasTarefa();
		//      = consegue mostrar os funcionarios que estão executando a tarefa 
		tarefa1.mostrar_funcionarioTarefa();                 
		tarefa2.mostrar_funcionarioTarefa();
		projeto1.mostrar_tarefaProjeto();
		
		//System.out.println(projeto1.tarefaProjeto[1].nomeTarefa);
