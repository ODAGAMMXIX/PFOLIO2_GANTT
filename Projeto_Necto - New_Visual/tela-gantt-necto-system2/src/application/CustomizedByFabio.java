...
public class CustomizedByFabio {

	@SuppressWarnings("unchecked")
	public static void main(String args[]) {
		Display display = new Display();
		Shell shell = new Shell(display);
		shell.setText("Gantt Chart - FATEC-NECTO: Carol, Denise, Odaga, Wilson");
		...
		GanttSection sectionOne = new GanttSection(ganttChart, "Project 01");
		GanttSection sectionTwo = new GanttSection(ganttChart, "Project 02");
		GanttSection sectionThree = new GanttSection(ganttChart, "Project 03");
		...
		// Create events
		GanttEvent eventOne = new GanttEvent(ganttChart, "Thinking01", sdEventOne, edEventOne, 35);
		...
		GanttEvent eventTwo = new GanttEvent(ganttChart, "Building02", sdEventTwo, edEventTwo, 10);
		...
		GanttEvent eventThree = new GanttEvent(ganttChart, "Operating", cpDate, cpDate, 75);
