...
public class GraphGantt {
	...
	public GraphGantt(String title, List<Projetos> tarefas) {
...
//conecta o banco e atualiza as tarefas:
			  				ProjetosDaoJDBC acess = new ProjetosDaoJDBC(DB.getConnection()); 
